...
def main():
    ...
    dataset = dataset.take(100*BATCH_SIZE)
    ...
    cycleGAN = SG.StarGAN([RESCALE_DIM, RESCALE_DIM, 3], len(labels), './OUTPUT/starGAN_celeba_TEST/', preprocess_model=preporcess_model)
